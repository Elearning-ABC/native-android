...
fun TestOptionScreen(
    ...
    val allTestInfoProgress = testInfoViewModel.getAllTestProgressByTestInfoId(testInfoId = testInfoId)
...
fun DifficultyChosenCard(
    ...
    ElevatedCard(
        modifier = Modifier.padding(vertical = 5.dp, horizontal = 16.dp).fillMaxWidth().shadow(
            elevation = 10.dp,
        ...
        Row(modifier = Modifier.fillMaxWidth().padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            when (status) {
                TestStatus.None -> Icon(Icons.Default.ArrowForward, contentDescription = null, tint = Color.LightGray)
                TestStatus.Playing -> {
...
fun BoxScore(testInfo: UITestInfo) {
    ...
    ElevatedCard(
        modifier = Modifier.padding(vertical = 15.dp, horizontal = 16.dp).fillMaxWidth().shadow(
            elevation = 10.dp,
            shape = RoundedCornerShape(corner = CornerSize(12.dp)),
            ambientColor = Color(0xff002395).copy(alpha = 0.3f),
            spotColor = Color(0xff002395).copy(alpha = 0.3f),
        ...
        Box {
            ...
            Row(
                ...
                Divider(
                    modifier = Modifier.fillMaxHeight().width(1.dp), color = Color(217, 219, 243).copy(alpha = 0.5f)
                )
                ScoreInfoColumn(
                    modifier = Modifier.weight(1f).padding(5.dp),
                    title = "Passing score",
